...
<html lang="en">
    <head>
        ...
        <title>Shooping Portal | Out for Delivery Orders</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="page-header">
                            <h1 class="mt-4">Out for Delivery Orders</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Out for Delivery Orders</li>
                            </ol>
                        </div>
                        <div class="card mb-4">
...
?>  
                                ...
                                <tr>
                                            ...
                                            <td><span class="status-pill"><?php echo htmlentities($row['orderStatus']);?></span></td>
                                            <td>
