...
<html lang="en">
    <head>
        ...
        <title>Shopping  | Manage Categories</title>
                                ...
                                <tr>
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <a href="edit-category.php?id=<?php echo $row['catid']?>" class="action-link" title="Edit category"><i class="fas fa-edit"></i></a>
                                                    <a href="manage-categories.php?id=<?php echo $row['catid']?>&del=delete" class="action-link delete" onClick="return confirm('Are you sure you want to delete?')" title="Delete category"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
