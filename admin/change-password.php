...
if(isset($_POST['submit']))
{
    ...
    $sql = mysqli_query($con, "SELECT password FROM admin WHERE username='" . $_SESSION['alogin'] . "' LIMIT 1");
    $num = mysqli_fetch_array($sql);
    if($num && passwordMatches($num['password'], $currentPassword))
    {
        $hashedPassword = hashPassword($newPassword);
        $conQuery = mysqli_query($con, "update admin set password='" . $hashedPassword . "', updationDate='$currentTime' where username='" . $_SESSION['alogin'] . "'");
