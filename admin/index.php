...
if (isset($_POST['submit'])) {
    ...
    $ret = mysqli_query($con, "SELECT * FROM admin WHERE username='$username' LIMIT 1");
    $num = mysqli_fetch_array($ret);

    if ($num && passwordMatches($num['password'], $password)) {
			...
			<div class="row">
				<div class="module module-login span4 offset4">
					<form class="form-vertical" method="post">
						...
						<span style="color:red;" ><?php echo isset($_SESSION['errmsg']) ? htmlentities($_SESSION['errmsg']) : ''; ?><?php unset($_SESSION['errmsg']);?></span>
